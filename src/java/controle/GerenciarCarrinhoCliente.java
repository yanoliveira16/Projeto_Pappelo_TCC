...
import modelo.ItemPedidoCliente;
 ...
 */
public class GerenciarCarrinhoCliente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                ArrayList<ItemPedidoCliente> itens = carrinho.getItens();
                ...
                if(op.equals("add")){
                    ...
                    boolean achou = false;
                    int i=0;
                    for(ItemPedidoCliente itemV:itens){
                    ...
                    if(red.equals("catalogo")){
                        ...
                        response.sendRedirect("resumo_venda_cliente.jsp");
                    }
